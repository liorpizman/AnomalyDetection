...
class NewModel(tk.Frame):
    ...
    def set_inputs_third_permutation(self):
        self.set_permutations(
            training_path="C:\\Users\\Yehuda Pashay\\Desktop\\flight_data\\Hackaton\\grid\\train",
            test_path="C:\\Users\\Yehuda Pashay\\Desktop\\flight_data\\Hackaton\\grid\\test",
            results_path="C:\\Users\\Yehuda Pashay\\Desktop\\flight_data\\Hackaton\\grid\\results"
        )
